...
var ArticleGetter = (function() {
	...
	function ArticleGetter() {
		...
		this.render = function() {
			var options = { url: this.endPoint + this.rand,
				method: 'GET',
				headers: {
		...
		this.randomPage = function(res) {
			...
			console.log(body.query.random[0]);
			key = body.query.random[0];
		...
		this.randomImage = function(res) {
			...
			imgTitlePromise.success(function(res) {
					//console.log("Tried to GET ", endPoint + urlEnd, "with a lastTitle of ", lastTitle);
					if (res.query.pages[Object.keys(res.query.pages)[0]].images !== undefined) {

						 imgTitlePromise.imgTitle = randArticle.toUrl(res.query.pages[Object.keys(res.query.pages)[0]].images[0].title);
			...
			.then(function() {
				...
				imgPromise.success(function(res) {
					...
					imgLocation = res.query.pages[Object.keys(res.query.pages)[0]].imageinfo[0];
